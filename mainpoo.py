...
class main(functions):
    ...
    def start_game(self):
        ...
        # bouttons de clavier
        self.btSubmit = Button(screen1, text="OK", font=font_btn,padx=10, pady=10, width=5,command=self.game)
        btSubmit_window = canvas2.create_window(310, 440, anchor="nw", window=self.btSubmit)
        ...
        self.bt1 = Button(screen1, text="1", font=font_btn, command=lambda: self.button_click(1), padx=10, pady=10, width=3)
        bt1_window = canvas2.create_window(80, 440, anchor="nw", window=self.bt1)
        self.bt2 = Button(screen1, text="2", font=font_btn, command=lambda: self.button_click(2), padx=10, pady=10, width=3)
        bt2_window = canvas2.create_window(150, 440, anchor="nw", window=self.bt2)
        self.bt3 = Button(screen1, text="3", font=font_btn, command=lambda: self.button_click(3), padx=10, pady=10, width=3)
        bt3_window = canvas2.create_window(220, 440, anchor="nw", window=self.bt3)

        self.bt4 = Button(screen1, text="4", font=font_btn, command=lambda: self.button_click(4), padx=10, pady=10, width=3)
        bt4_window = canvas2.create_window(80, 510, anchor="nw", window=self.bt4)
        self.bt5 = Button(screen1, text="5", font=font_btn, command=lambda: self.button_click(5), padx=10, pady=10, width=3)
        bt5_window = canvas2.create_window(150, 510, anchor="nw", window=self.bt5)
        self.bt6 = Button(screen1, text="6", font=font_btn, command=lambda: self.button_click(6), padx=10, pady=10, width=3)
        bt6_window = canvas2.create_window(220, 510, anchor="nw", window=self.bt6)

        self.bt7 = Button(screen1, text="7", font=font_btn, command=lambda: self.button_click(7), padx=10, pady=10, width=3)
        bt7_window = canvas2.create_window(80, 580, anchor="nw", window=self.bt7)
        self.bt8 = Button(screen1, text="8", font=font_btn, command=lambda: self.button_click(8), padx=10, pady=10, width=3)
        bt8_window = canvas2.create_window(150, 580, anchor="nw", window=self.bt8)
        self.bt9 = Button(screen1, text="9", font=font_btn, command=lambda: self.button_click(9), padx=10, pady=10, width=3)
        bt9_window = canvas2.create_window(220, 580, anchor="nw", window=self.bt9)
        canvas2.pack()
        screen1.mainloop()
        #methode game
    ...
    def win(self):
        ...
        btQuit = Button(text='QUITTER', font=("Algerian", 12), fg="white", bg="#f00020", width=10, height=2,
                        command=quit)
        canvas3.create_text(250, 30,fill="black",font=("bold",15), text="Bravoo! Vous avez deviné le code secret :"+str(self.code_secret()))
